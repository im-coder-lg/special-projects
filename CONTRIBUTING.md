...
## Report bugs using Github's [issues](https://github.com/coder-lg-/special-projects/issues)
We use GitHub issues to track public bugs. Report a bug by [_**opening a new issue**_](https://github.com/coder-lg-/special-projects/issues/new) and choosing a template(`bug`/`feature request`); it's that easy!
